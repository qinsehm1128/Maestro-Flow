...
export function isPathWithinAllowedDirectories(
  ...
  return allowedDirectories.some(dir => {
    ...
    // Require a path separator boundary so a sibling sharing a name prefix
    // (e.g. "/home/user/project-evil" vs "/home/user/project") is not matched.
    const dirWithSep = canonicalDir.endsWith(sep) ? canonicalDir : canonicalDir + sep;
    return canonicalTarget.startsWith(dirWithSep);
  });
}
