...
/**
 * Truncate by eliding the MIDDLE with a single ellipsis char "\u2026",
 * keeping the head and tail so the result length is exactly `max`.
 * Useful when both ends of a string carry meaning (e.g. long ids/paths).
 */
